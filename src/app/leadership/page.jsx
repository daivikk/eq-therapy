...
//           <h1 className="text-4xl font-['Instrument Sans'] text-[#2C1A47] text-center mb-16">
//             Our Leadership Team
//           </h1>
...
//                 />
//               </div>
//               <h2 className="text-2xl font-['Instrument Sans'] text-[#2C1A47] mb-3">Dr. Eric Gutgarts</h2>
//               <p className="text-lg text-[#2C1A47] mb-4">Co-Founder & Clinical Director</p>
//               <div className="space-y-4 text-[#2C1A47]">
...
//               </div>
//               <div className="mt-6">
//                 <div className="text-[#2C1A47] font-medium mb-2">Limited Availability</div>
//                 <div className="grid grid-cols-2 gap-2">
//                   {['Tuesday', 'Thursday'].map((day) => (
//                     <div key={day} className="bg-[#F0E6FF] p-3 rounded-lg">
//                       <div className="text-[#2C1A47] font-medium">{day}</div>
//                       <div className="text-sm text-[#2C1A47]">2:00 PM - 4:00 PM</div>
//                     </div>
//                   ))}
//                 </div>
//               </div>
...
//                 />
//               </div>
//               <h2 className="text-2xl font-['Instrument Sans'] text-[#2C1A47] mb-3">Megan Burton</h2>
//               <p className="text-lg text-[#2C1A47] mb-4">Co-Founder and Executive Director</p>
//               <div className="space-y-4 text-[#2C1A47]">
...
//               </div>
//               <div className="mt-6">
//                 <div className="text-[#2C1A47] font-medium mb-2">Availability</div>
//                 <div className="grid grid-cols-2 gap-2">
//                   {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'].map((day) => (
//                     <div key={day} className="bg-[#F0E6FF] p-3 rounded-lg">
//                       <div className="text-[#2C1A47] font-medium">{day}</div>
//                       <div className="text-sm text-[#2C1A47]">9:00 AM - 5:00 PM</div>
//                     </div>
//                   ))}
//                 </div>
//               </div>
